...
app = FastAPI(title="Time Capsule : Aerial View Generator", description="Aerial view generator using Vertex AI and Mapbox")
...
@app.get("/")
async def root():
    return {"message": "DaftCraft - Aerial View Generator", "status": "running"}
